...
public class EmailSender
{
    public void SendActivationEmail(string userEmail, string token){
        ...
        string htmlString = @"<html>
                      ...
                      <p><a href='https://iberiadelivery.daw2122.iescarlesvallbona.cat/User/ActivateAccount?token="+ token +@"'>Link</p>
                      </body>
                      </html>
                     "; 
    ...
    public void ResetPasswordEmail(string userEmail, string token){
        ...
        string htmlString = @"<html>
                      ...
                      <p><a href='https://iberiadelivery.daw2122.iescarlesvallbona.cat/User/ResetPassword?token="+ token +@"'>Link</p>
                      </body>
                      </html>
                     "; 
