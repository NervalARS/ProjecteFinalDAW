...
-- iberiadb.dbo.adress definition

-- Drop table

-- DROP TABLE iberiadb.dbo.adress;

CREATE TABLE iberiadb.dbo.adress (
	id int IDENTITY(1,1) NOT NULL,
	first_name varchar(255) COLLATE Modern_Spanish_CI_AS NOT NULL,
	last_name varchar(255) COLLATE Modern_Spanish_CI_AS NOT NULL,
	...
	target_number varchar(20) COLLATE Modern_Spanish_CI_AS NOT NULL,
