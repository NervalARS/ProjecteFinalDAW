...
CREATE TABLE [order] (
	...
	CONSTRAINT order_FK_1 FOREIGN KEY (user_id) REFERENCES [user](id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE product (
	...
	CONSTRAINT product_user_FK FOREIGN KEY (provider_id) REFERENCES [user](id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE comments (
	...
	CONSTRAINT comments_ProductFK FOREIGN KEY (product_id) REFERENCES product(id) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE ln_order (
	...
	CONSTRAINT ln_order_Order_FK FOREIGN KEY (num_order) REFERENCES [order](id) ON DELETE CASCADE ON UPDATE CASCADE,
	CONSTRAINT ln_order_Product_FK FOREIGN KEY (ref_product) REFERENCES product(id)
);
